...
$title = 'Danh sách bệnh - Songxanh24h.vn - Chuyên trang sức khỏe, dinh dưỡng, làm đẹp';
                ...
                <section id="<?= $alpha ?>">
                    ...
                    <div class="row d-mobile-none">
                        ...
                        foreach ($item1 as $item) : ?>
                            <div class="col-md-3">
                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['crawl/sick-detail', 'slug' => $item->slug]) ?>">
