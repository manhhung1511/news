...
$title = 'Thông tin tra cứu Hoạt Chất dành cho mọi người | Songxanh24h.vn';
$this->title = $title;

$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Giới thiệu về các loại hoạt chất, dược tính, công dụng, liều dùng, các bài thuốc chữa bệnh và những lưu ý đặc biệt khi bào chế.'
], 'description');
?>
                ...
                <section id="<?= $alpha ?>">
                    ...
                    <div class="row d-mobile-none">
                        ...
                        foreach ($item1 as $item) : ?>
                            <div class="col-md-3">
                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['crawl/active-detail', 'slug' => $item->slug]) ?>">
