...
!(function (e, t) {
                ...
                if (y) {
                  ...
                  if (((d = [a ? y.firstChild : y.lastChild]), a && v)) {
                    for (
                      b =
                        (h =
                          (c = (u = (p = (f = y)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ &&
                          c[1]) && c[2],
                        f = h && y.childNodes[h];
                    ...
                    (v &&
                      (b = h =
                        (c = (u = (p = (f = t)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ &&
                        c[1]),
                    !1 === b)
                  )
                    for (
    ...
    if (((n = n || O), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          w.merge(this, w.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : y, !0)),
  ...
  (w.Callbacks = function (e) {
    ...
    w.extend({
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
              ...
              return w
                .Deferred(function (e) {
                  n[0][3].add(a(0, e, d(o) ? o : P, e.notifyWith)),
                    n[1][3].add(a(0, e, d(t) ? t : P)),
                    n[2][3].add(a(0, e, d(i) ? i : R));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (t <= 1 && (H(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || d(r[n] && r[n].then)))
          return a.then();
  ...
  (w.fn.ready = function (e) {
    ...
    "complete" === y.readyState || ("loading" !== y.readyState && !y.documentElement.doScroll)
      ...
      : (y.addEventListener("DOMContentLoaded", W), e.addEventListener("load", W));
  ...
  function se(e, t, n, i) {
    ...
    if (u && u[3] !== c) {
      for (l /= 2, c = c || u[3], u = +l || 1; a--; )
        w.style(e, t, u + c), (1 - r) * (1 - (r = s() / l || 0.5)) <= 0 && (a = 0), (u /= r);
      (u *= 2), w.style(e, t, u + c), (n = n || []);
    }
    return (
      n && ((u = +u || +l || 0), (o = n[1] ? u + (n[1] + 1) * n[2] : +n[2]), i && ((i.unit = c), (i.start = u), (i.end = o))), o
    );
  }
  var le = {};
  function ce(e, t) {
      ...
      if (y && (l = y.events)) {
        for (c = (t = (t || "").match(I) || [""]).length; c--; )
          if (((h = g = (s = _e.exec(t[c]) || [])[1]), (d = (s[2] || "").split(".").sort()), h)) {
            ...
            a &&
              !f.length &&
              ((p.teardown && !1 !== p.teardown.call(e, d, y.handle)) || w.removeEvent(e, h, y.handle), delete l[h]);
  ...
  function Ie(e, t, n, i) {
    ...
    if (f && ((a = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === o.childNodes.length && (o = a), a || i)) {
      for (l = (s = w.map(ye(o, "script"), Me)).length; p < f; p++)
        (c = o), p !== g && ((c = w.clone(c, !0, !0)), l && w.merge(s, ye(c, "script"))), n.call(e[p], c, p);
      if (l)
          ...
          (c = s[p]),
            de.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : v(c.textContent.replace(Oe, ""), c, u));
    }
    return e;
  }
  function Pe(e, t, n) {
    for (var i, o = t ? w.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || w.cleanData(ye(i)),
  ...
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n) for (r = r || ye(e), a = a || ye(u), i = 0, o = r.length; i < o; i++) De(r[i], a[i]);
        else De(e, u);
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          l = $e.test(t),
          c = e.style;
        if ((l || (t = Ye(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n))
  ...
  function st() {
    nt &&
      (!1 === y.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, w.fx.interval), w.fx.tick());
  }
  function lt() {
    return (
      e.setTimeout(function () {
    ...
    prefilters: [
      function (e, t, n) {
        ...
        if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
          ...
          h))
            l ||
              (y ? "hidden" in y && (g = y.hidden) : (y = Q.access(e, "fxshow", {display: c})),
              r && (y.hidden = !g),
              g && ce([e], !0),
              f.done(function () {
    ...
    w.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, o, r, a;
              if (i) for (o = 0, r = w(this), a = vt(e); (t = a[o++]); ) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
      ...
      serializeArray: function () {
        return this.map(function () {
          ...
          .filter(function () {
            var e = this.type;
            return (
              this.name && !w(this).is(":disabled") && At.test(this.nodeName) && !Ct.test(e) && (this.checked || !fe.test(e))
            );
          })
          .map(function (e, t) {
            var n = w(this).val();
  ...
  (qt.href = _t.href),
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        if (
          (h.data && h.processData && "string" != typeof h.data && (h.data = w.param(h.data, h.traditional)), Wt(Pt, h, n, E), c)
        )
          return E;
            ...
            p
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (k = "notmodified")
                  : ((k = x.state), (f = x.data), (p = !(y = x.error))))
    ...
    (w.parseHTML = function (e, t, n) {
      return "string" != typeof e
        ...
        : ("boolean" == typeof t && ((n = t), (t = !1)),
          t ||
            (h.createHTMLDocument
              ? (((i = (t = y.implementation.createHTMLDocument("")).createElement("base")).href = y.location.href),
    ...
    (w.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === c && (e.style.position = "relative"),
          ...
          "using" in t
            ? t.using.call(e, p)
            : ("number" == typeof p.top && (p.top += "px"), "number" == typeof p.left && (p.left += "px"), u.css(p));
      },
    }),
    w.fn.extend({
      offset: function (e) {
  ...
  (function (e, t) {
    ...
    function F(e, t, n) {
      ...
      if (!o) {
        var r = "`" + t + "`";
        console.warn(
          "`" + n + "` modifier is required by " + r + " modifier in order to work, be sure to include it before " + r + "!"
        );
      }
      return o;
    }
                ...
                f = {
                  ...
                  secondary: function (e) {
                    var n = "right" === e ? "left" : "top",
                      i = p[n];
                    return (
                      p[e] > c[e] && !t.escapeWithReference && (i = U(p[n], c[e] - ("right" === e ? p.width : p.height))),
                      ee({}, n, i)
                    );
                  },
                };
          ...
          keepTogether: {
            ...
            fn: function (e) {
              var t = e.offsets,
                ...
                c = a ? "width" : "height";
              return (
                n[s] < r(i[l]) && (e.offsets.popper[l] = r(i[l]) - n[c]), n[l] > r(i[s]) && (e.offsets.popper[l] = r(i[s])), e
              );
            },
          },
          arrow: {
            ...
            fn: function (e, n) {
              ...
              var r = e.placement.split("-")[0],
                ...
                g = c ? "bottom" : "right",
                y = E(o)[u];
              l[g] - y < s[f] && (e.offsets.popper[f] -= s[f] - (l[g] - y)),
                l[f] + y > s[g] && (e.offsets.popper[f] += l[f] + y - s[g]),
              ...
              return (
                (w = Y(U(s[u] - y, w), 0)), (e.arrowElement = o), (e.offsets.arrow = (ee((i = {}), f, X(w)), ee(i, h, ""), i)), e
              );
            },
            element: "[x-arrow]",
          },
  ...
  (function (e, t) {
      ...
      .on("click.bs.button.data-api", '[data-toggle^="button"]', function (e) {
        ...
        if (
          ...
          ("INPUT" !== n.tagName && "LABEL" === t.tagName) ||
            d._jQueryInterface.call(o.default(t), "toggle", "INPUT" === n.tagName);
        }
      })
          ...
          (t.show = function () {
            ...
            if (
              ...
              if ((o.default(this._element).trigger(r), !r.isDefaultPrevented())) {
                t &&
                  (e._jQueryInterface.call(o.default(t).not(this._selector), "hide"),
      ...
      N = (function () {
        ...
        return (
          ...
          (t._getPopperConfig = function () {
            ...
            return (
              "static" === this._config.display && (e.modifiers.applyStyle = {enabled: !1}), l({}, e, this._config.popperConfig)
            );
          }),
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (n || ((n = new e(this, "object" == typeof t ? t : null)), o.default(this).data("bs.dropdown", n)),
                "string" == typeof t)
              ) {
          ...
          (e._clearMenus = function (t) {
            if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
              for (
                var n = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, r = n.length;
                i < r;
                i++
              ) {
      ...
      $ = (function () {
        ...
        return (
          ...
          (t.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                n ||
                  ((n = new this.constructor(e.currentTarget, this._getDelegateConfig())), o.default(e.currentTarget).data(t, n)),
          ...
          (t.getTitle = function () {
            ...
            return (
              e || (e = "function" == typeof this.config.title ? this.config.title.call(this.element) : this.config.title), e
            );
          }),
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                ...
                (i || ((i = new e(this, r)), n.data("bs.tooltip", i)), "string" == typeof t)
              ) {
                if (void 0 === i[t]) throw new TypeError('No method named "' + t + '"');
                i[t]();
              }
        ...
        return (
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (n || ((n = new e(this, "object" == typeof t && t)), o.default(this).data("bs.scrollspy", n)),
                "string" == typeof t)
              ) {
                if (void 0 === n[t]) throw new TypeError('No method named "' + t + '"');
                n[t]();
    ...
    o
      .default(document)
      .on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
  ...
  (function (e, t) {
    ...
    function m(e, n) {
      ...
      n.isScrollbarYUsingRight
        ? n.isRtl
          ? (a.right =
              n.contentWidth - (n.negativeScrollAdjustment + e.scrollLeft) - n.scrollbarYRight - n.scrollbarYOuterWidth - 9)
      ...
      S = {
              ...
              (e.settings.suppressScrollX && 0 !== s) ||
                ...
                (function (i, o) {
                  ...
                  if (0 === o) {
                    ...
                    if ((0 === a && 0 > i) || (a >= e.contentWidth - e.containerWidth && 0 < i))
                      return !e.settings.wheelPropagation;
                  }
                  return !0;
        ...
        wheel: function (i) {
          ...
          void 0 === window.onwheel
            ? void 0 !== window.onmousewheel && i.event.bind(a, "mousewheel", r)
            : i.event.bind(a, "wheel", r);
        },
        touch: function (i) {
          function o(n, o) {
            var r = t(f.scrollTop),
            ...
            i.settings.swipeEasing &&
              ...
              (m = setInterval(function () {
                return i.isInitialized
                  ...
                  : y.x || y.y
                  ? 0.01 > e(y.x) && 0.01 > e(y.y)
                    ? void clearInterval(m)
                    : (r(30 * y.x, 30 * y.y), (y.x *= 0.8), void (y.y *= 0.8))
                  : void clearInterval(m);
              }, 10)));
          }
              ...
              : T.supportsIePointer &&
                (window.PointerEvent
                  ...
                  : window.MSPointerEvent &&
                    (i.event.bind(f, "MSPointerDown", l),
                    i.event.bind(f, "MSPointerMove", u),
                    i.event.bind(f, "MSPointerUp", p)));
          }
        },
      },
      C = function (e, r) {
  ...
  (function (e, t, n, i) {
    ...
    function R() {
      ...
      (this.touch = new I(this.manager, e)),
    ...
    l(N, _, {
      handler: function (e) {
        ...
        t & be && 0 === e.button && (this.pressed = !0),
          ...
          this.pressed &&
            (t & we && (this.pressed = !1),
            this.callback(this.manager, t, {pointers: [e], changedPointers: [e], pointerType: me, srcEvent: e}));
      },
    });
    var Pe = {pointerdown: be, pointermove: xe, pointerup: we, pointercancel: _e, pointerout: _e},
      Re = {2: ye, 3: "pen", 4: me, 5: "kinect"},
      He = "pointerdown",
      ...
      handler: function (e) {
        ...
        if ((t === be && (this.started = !0), this.started)) {
          ...
          t & (we | _e) && n[0].length - n[1].length == 0 && (this.started = !1),
            this.callback(this.manager, t, {pointers: n[0], changedPointers: n[1], pointerType: ye, srcEvent: e});
        }
      },
    });
    ...
    function e(e) {
      function t(t, i) {
        ...
        if (!(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked || !e(t).data("blockUI.isBlocked")) {
          ...
          if (u || S) {
            if (
              (g && i.allowBodyStretch && e.support.boxModel && e("html,body").css("height", "100%"),
          ...
          if (
            (y && (i.theme ? w.find(".ui-widget-content").append(y) : w.append(y), (y.jquery || y.nodeType) && e(y).show()),
      ...
      function n(t, n) {
        ...
        u && (clearTimeout(u), l.removeData("blockUI.timeout")),
          ...
          n.cursorReset &&
            (a.length > 1 && (a[1].style.cursor = n.cursorReset), a.length > 2 && (a[2].style.cursor = n.cursorReset)),
          s && (f = h = null),
          n.fadeOut
            ? ((r = a.length),
  ...
  function () {
      ...
      x = {
        ...
        N = function () {
          ...
          return (
            (n = arguments[0]),
            (t = arguments[1]),
            (e = 3 <= arguments.length ? $.call(arguments, 2) : []),
          ...
          for (t = arguments[0], r = 0, a = (i = 2 <= arguments.length ? $.call(arguments, 1) : []).length; a > r; r++)
            if ((n = i[r]))
              for (e in n)
                Q.call(n, e) &&
                  ((o = n[e]),
                  null != t[e] && "object" == typeof t[e] && null != o && "object" == typeof o ? w(t[e], o) : (t[e] = o));
          return t;
        },
        y = function (e) {
          var t, n, i, o, r;
        ...
        z = 0,
        B = (Y = ["ajax", "document", "eventLag", "elements"]).length;
      B > z;
      z++
    )
      !0 === L[(P = Y[z])] && (L[P] = x[P]);
    (l = (function (e) {
        ...
        function t() {
          ...
          if (null != q && L.ajax.trackWebSockets) {
            window.WebSocket = function (e, t) {
              var i;
              return (
                (i = null != t ? new q(e, t) : new q(e)),
                I("socket") && n.trigger("request", {type: "socket", url: e, protocols: t, request: i}),
                i
              );
            };
            try {
        ...
        return (
          (e.prototype.watch = function (e) {
            ...
            return (
              ...
              (t = e.request),
              (o = e.url),
              D(o) ? void 0 : ((n = "socket" === i ? new h(t) : new d(t)), this.elements.push(n))
            );
          }),
          e
        );
        ...
        if (((this.progress = 0), null != window.ProgressEvent))
          ...
          (o = e.onreadystatechange),
            (e.onreadystatechange = function () {
              var t;
              return (
                0 === (t = e.readyState) || 4 === t ? (a.progress = 100) : 3 === e.readyState && (a.progress = 50),
      ...
      (i = function (e) {
        ...
        for (
          null == e && (e = {}),
            ...
            n = 0,
            i = (r = e.selectors).length;
          i > n;
          n++
        )
          (t = r[n]), this.elements.push(new o(t));
      }),
      (o = (function () {
        function e(e) {
        ...
        (this.progress = 0),
          ...
          (t = setInterval(function () {
            ...
            return (
              ...
              (e = y(o)),
              ++i >= L.eventLag.minSamples && e < L.eventLag.lagThreshold
            ...
            return (
              ...
              t === this.last
                ...
                : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate),
                  (this.catchup = (t - this.progress) / L.catchupTime),
      ...
      (p = {ajax: e, elements: i, document: n, eventLag: r}),
      (C = function () {
        var e, n, i, o, r, a, s, l;
        for (c.sources = R = [], n = 0, o = (a = ["ajax", "elements", "document", "eventLag"]).length; o > n; n++)
          !1 !== L[(e = a[n])] && R.push(new p[e](L[e]));
        ...
        return (
          ...
          (g = M(function (t, n) {
            ...
            for (100 - m.progress, o = d = 0, r = !0, l = g = 0, b = R.length; b > g; l = ++g)
              for (
                P = R[l], h = null != j[l] ? j[l] : (j[l] = []), u = y = 0, x = (s = null != (w = P.elements) ? w : [P]).length;
                x > y;
                u = ++y
              )
                  ...
                  if (!i.returnObjects && !this.options.returnObjects)
                    return (
                      ...
                      this.options.returnedObjectHandler
                        ? this.options.returnedObjectHandler(y, g, i)
                  ...
                  !1 !== i.nest &&
                    (e = this.interpolator.nest(
                      ...
                      function () {
                        ...
                        return r && r[0] === n[0]
                          ? (a.logger.warn("It seems you are nesting recursively key: ".concat(n[0], " in key: ").concat(t[0])),
                            null)
                ...
                return (
                  null != e &&
                    ...
                    (e = T.handle(
                      ...
                      e,
                      t,
                      this.options && this.options.postProcessPassResolved ? n({i18nResolved: o}, i) : i,
                      this
                    )),
                  e
                );
              ...
              if (
                ...
                (s.logger = f),
                  ...
                  this.modules.i18nFormat &&
                    ((s.i18nFormat = r(this.modules.i18nFormat)), s.i18nFormat.init && s.i18nFormat.init(this)),
  ...
  (function (e, t) {
    ...
    function l(e, t, n, i, o) {
      i && "object" === a(i) && (o || (i._t = new Date()), (i = s("", i).slice(1))),
        t.queryStringParams && (e = s(e, t.queryStringParams));
      try {
        var r;
      ...
      init: function (n, i) {
        function o(t, i, o) {
          ...
          if (0 !== i.length) {
            ...
            if ((i.indexOf(";") === i.length - 1 && (i = i.substr(0, i.length - 2)), "html" === a))
        ...
        function r(t, n) {
          ...
          if ((r || void 0 === r || !1 === r || (r = t.text() || t.val()), r)) {
            ...
            if (
              (l && (a = t.find(l) || t),
              n || !0 !== s.useOptionsAttr || (n = t.data(s.optionsAttr)),
              (n = n || {}),
              r.indexOf(";") >= 0)
            ) {
              var c = r.split(";");
  ...
  */ !(function () {
      ...
      function (e, t, n) {
        ...
        e.exports = function (e) {
          ...
          else for (p = v.call(f), n = new h(); !(u = p.next()).done; m++) l(n, m, y ? r(p, g, [u.value, m], !0) : u.value);
          return (n.length = m), n;
        };
      },
      function (e, t, n) {
      ...
      function (e, t, n) {
        ...
        (e.exports =
          ...
          function (e, t) {
            var n;
            return (
              null !== e ? ((u.prototype = i(e)), (n = new u()), (u.prototype = null), (n[c] = e)) : (n = p()),
              void 0 === t ? n : o(n, t)
            );
          }),
          (a[c] = !0);
        ...
        e.exports = function (e, t, n, u, h, v, b) {
          ...
          if (
            (L &&
              ...
              d !== Object.prototype &&
                x.next &&
                (p || r(x) === d || (a ? a(x, d) : "function" != typeof x[y] && l(x, y, m)), s(x, E, !0, !0), p && (f[E] = m))),
            "values" == h &&
              C &&
              "values" !== C.name &&
              ((T = !0),
      ...
      return this.each(function () {
        ...
        function w() {
          if (r.booster) {
            ...
            return (
              r.maxboostedstep && e > r.maxboostedstep && ((e = r.maxboostedstep), (u = Math.round(u / e) * e)),
              Math.max(r.step, e)
            );
          }
          return r.step;
